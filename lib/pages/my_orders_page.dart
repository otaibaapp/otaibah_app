...
class MyOrdersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("سجل طلباتي", style: TextStyle(color: Colors.black)),
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => OrderDetailsPage(orderId: o["orderId"]),
                                ),
                              );
                            },
  ...
  String _statusText(String status) {
    switch (status) {
      case "pending": return "طلبك قيد المراجعة";
      case "accepted": return "تم القبول";
      case "preparing": return "قيد التحضير";
      case "on_the_way": return "قيد التوصيل";
